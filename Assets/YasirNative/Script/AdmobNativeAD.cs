...
public class AdmobNativeAD : MonoBehaviour
{
    ...
    void Awake ()
	{
        ...
        MobileAds.Initialize("ca-app-pub-1579727795693040~4066378144");
    }
    ...
    {
        AdLoader adLoader = new AdLoader.Builder("ca-app-pub-1579727795693040/7674666267").ForUnifiedNativeAd().Build();
